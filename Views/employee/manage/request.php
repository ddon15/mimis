    ...
    <div class="requestStatistics">
        <div class="top">
            ...
            <ul class="nav nav-tabs menu">
                ...
                <li class = "excuseToAbsentTabMenu"><a data-toggle="tab" href="#">ExcuseToAbsent</a></li>
            </ul>
        </div>
            <div class="main">
                  ...
                  <div id="leaveContainer" class="tab-pane fade">
                    ...
                    <div class = "otForm">
                      <form class="form-ot" method="post" id="ot-form">
                          ...
                          <div class="form-group submit">
                            <button type="submit" class="btn btn-default" name="btn-ot" id="btn-ot">
                            <span class="glyphicon glyphicon-log-in"></span> &nbsp; Send Request
                            </button>
                          </div>  
                        </form>
